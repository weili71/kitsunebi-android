package com.weilizan.kitsunebi.sample
...
import com.weilizan.kitsunebi.databinding.ActivityCustomUiBinding
...
class CustomUIActivity : AppCompatActivity() {
    ...
    private fun setupView() {
        setSupportActionBar(binding.toolbar.rootView as Toolbar)
