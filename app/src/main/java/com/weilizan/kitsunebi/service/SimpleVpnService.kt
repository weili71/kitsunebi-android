package com.weilizan.kitsunebi.service
...
open class SimpleVpnService : VpnService() {
    ...
    override fun onStartCommand(intent: Intent?, flags: Int, startId: Int): Int {
        ...
        bgThread = thread(start = true) {
            ...
            val localDns = Preferences.getString(
                applicationContext,
                getString(R.string.local_dns),
                "223.5.5.5"
            )?:""
            ...
            val isEnablePerAppVpn = Preferences.getBool(
                applicationContext,
                getString(R.string.is_enable_per_app_vpn),
                null
            )
            @TargetApi(21)
            if (isEnablePerAppVpn) {
                val perAppMode = Preferences.getString(
                    applicationContext,
                    getString(R.string.per_app_mode),
                    null
                )
                when (Integer.parseInt(perAppMode)) {
                    0 -> {
                        val allowedAppList = Preferences.getString(
                            applicationContext,
                            getString(R.string.per_app_allowed_app_list),
                            null
                        )?:""
                    ...
                    1 -> {
                        val disallowedAppList = Preferences.getString(
                            applicationContext,
                            getString(R.string.per_app_disallowed_app_list),
                            null
                        )?:""
            ...
            val enableProxyLogging = Preferences.getBool(
                applicationContext,
                getString(R.string.is_enable_proxy_logging),
                null
            )
...
//            }
            ...
            var sniffing =
                Preferences.getString(applicationContext, getString(R.string.sniffing), "http,tls")?:""
            ...
            val inboundTag = Preferences.getString(
                applicationContext,
                getString(R.string.inbound_tag),
                "tun2socks"
            )
