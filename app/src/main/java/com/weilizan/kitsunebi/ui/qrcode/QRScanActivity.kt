...
import com.weilizan.kitsunebi.databinding.ActivityQrBinding
import com.weilizan.kitsunebi.util.toast
import java.io.File

class QRScanActivity : AppCompatActivity(), SensorEventListener {
...
//        window.addFlags(WindowManager.LayoutParams.FLAG_TRANSLUCENT_STATUS)
    ...
    private fun initView() {
        //bi~
        if (options.isShowTitle) title = options.title
